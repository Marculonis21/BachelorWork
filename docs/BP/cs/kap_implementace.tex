...
simulátoru \emph{MuJoCo} (MuJoCo bylo popsáno v základních pojmech v oddílu
\ref{MuJoCo}) s ostatními třídami je vysvětlena v oddílu \ref{imp:robots}. V
sekci \ref{imp:experimentsetter} představíme třídu \texttt{Experiment} modulu
    ...
    \item metody využívané evolučním algoritmem:
        \begin{itemize}
            ...
            \item \texttt{switch\_evo\_phase()} -- metoda využívána z hlavního
                ...
                morfologie při sériovém vývoji řízení a morfologie),
        \end{itemize}
