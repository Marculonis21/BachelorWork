...
def popup_load_experiments():
    ...
    main = [[sg.Listbox(experiments.get_experiment_names(), select_mode=sg.SELECT_MODE_SINGLE, expand_x=True, expand_y=True, pad=(10,5), key="SELECTED_EXPERIMENT")],
    ...
    params = None
    popup = sg.Window("Load experiment", layout, size=(700,400), font=DEFAULT_FONT, keep_on_top=True, modal=True)
    while True:
        event, values = popup.read()
